...
### 🔹 Run a Model Inference Example (Geneformer)

Make sure all required parameters are set, including pre-trained model weight path, raw h5ad file path and embedding save path.
...
### 🔹 Run a Model Inference by Julia Example (cellfishing.jl)
...
### 🔹 Run Retrieval Example (PBMC-Ding)
