...
if __name__ == '__main__':
    ...
    scimilarity_path = "/Users/liuxinyuan/Desktop/new_projects/cell_retrieval/result_base/novel_discovery_pancreas"
    ...
    for platform in platforms:
        try:
            ...
            for model_name, y_scores in models_dict.items():
                precision_dict[platform][model_name]=precision_score(y_true=y_true, y_pred=y_scores<args.threshold)
                recall_dict[platform][model_name]= recall_score(y_true=y_true, y_pred=y_scores<args.threshold)
                f1_dict[platform][model_name] = f1_score(y_true=y_true, y_pred=y_scores<args.threshold)
                accuracy_dict[platform][model_name] = accuracy_score(y_true=y_true, y_pred=y_scores<args.threshold)
