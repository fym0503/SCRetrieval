...
if __name__ == '__main__':
    ...
    for model_name, y_scores in models_dict.items():
        ...
        precision_dict[model_name]=precision_score(y_true=y_true, y_pred=y_scores<thres)
        recall_dict[model_name] = recall_score(y_true=y_true, y_pred=y_scores<thres)
        f1_dict[model_name] = f1_score(y_true=y_true, y_pred=y_scores<thres)
        accuracy_dict[model_name] = accuracy_score(y_true=y_true, y_pred=y_scores<thres)
